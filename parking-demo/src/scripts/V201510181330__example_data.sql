-- insert users
INSERT INTO users (LOGIN, EMAIL, FIRSTNAME, LASTNAME, PASSWORD, REMOVED, VERSION) 
VALUES ('admin', 'admin@mail.com', 'John', 'Admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', 0, 1);
INSERT INTO user_groups VALUES ('admin', 'ADMIN');
INSERT INTO user_groups VALUES ('admin', 'USER');

INSERT INTO users (LOGIN, EMAIL, FIRSTNAME, LASTNAME, PASSWORD, REMOVED, VERSION) 
VALUES ('user', 'user@mail.com', 'Tony', 'User', '04f8996da763b7a969b1028ee3007569eaf3a635486ddab211d512c85b9df8fb', 0, 1);
INSERT INTO user_groups VALUES ('user', 'USER');

INSERT INTO users (LOGIN, EMAIL, FIRSTNAME, LASTNAME, PASSWORD, REMOVED, VERSION) 
VALUES ('donald', 'donald@mail.com', 'Donald', 'Duck', '04f8996da763b7a969b1028ee3007569eaf3a635486ddab211d512c85b9df8fb', 0, 1);
INSERT INTO user_groups VALUES ('donald', 'USER');

INSERT INTO users (LOGIN, EMAIL, FIRSTNAME, LASTNAME, PASSWORD, REMOVED, VERSION) 
VALUES ('mickey', 'mickey@mail.com', 'Mickey', 'Mouse', '04f8996da763b7a969b1028ee3007569eaf3a635486ddab211d512c85b9df8fb', 0, 1);
INSERT INTO user_groups VALUES ('mickey', 'USER');

INSERT INTO users (LOGIN, EMAIL, FIRSTNAME, LASTNAME, PASSWORD, REMOVED, VERSION) 
VALUES ('speedy', 'speedy@mail.com', 'Speedy', 'Gonzalez', '04f8996da763b7a969b1028ee3007569eaf3a635486ddab211d512c85b9df8fb', 0, 1);
