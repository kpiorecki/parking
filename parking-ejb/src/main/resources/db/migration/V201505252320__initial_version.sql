...
CREATE TABLE users (LOGIN VARCHAR(255) NOT NULL, EMAIL VARCHAR(255) NOT NULL, FIRSTNAME VARCHAR(255), LASTNAME VARCHAR(255), PASSWORD VARCHAR(64) NOT NULL, REMOVED SMALLINT DEFAULT 0 NOT NULL, VERSION INTEGER, PRIMARY KEY (LOGIN));
