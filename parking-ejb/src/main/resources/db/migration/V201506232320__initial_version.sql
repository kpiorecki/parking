...
CREATE TABLE parkings (UUID VARCHAR(36) NOT NULL, CAPACITY INTEGER NOT NULL, NAME VARCHAR(255) NOT NULL, VERSION INTEGER, CITY VARCHAR(255), NUMBER VARCHAR(32), POSTALCODE VARCHAR(32), STREET VARCHAR(255), PRIMARY KEY (UUID));
